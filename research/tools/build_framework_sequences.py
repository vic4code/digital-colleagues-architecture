...
'claude':('Goal continuation',['Turn ends','Goal evaluator','Condition unmet','Next turn','Re-evaluate'],['Agent turn','Goal evaluator','Session','Tools'],[(0,1,'Internal Event: turn finished'),(1,1,'Evaluate transcript evidence'),(1,2,'Unmet → continuation'),(2,0,'Start next turn'),(0,3,'Run tools; results enter transcript'),(0,1,'Next evaluation')],'Met / impossible / actionable error → Stop。Stop hook 是另一個可自訂的完成檢查入口。'),
